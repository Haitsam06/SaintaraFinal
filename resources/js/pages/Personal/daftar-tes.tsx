        ...
        <div className="relative bg-black text-white pt-12 pb-24 px-6 rounded-b-[3rem] mb-10 shadow-lg overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
                ...
                <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">
                    Pilih paket analisis karakter yang sesuai dengan kebutuhan Anda. 
                    Mulai perjalanan mengenal diri sendiri hari ini.
                </p>
            </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 -mt-16 pb-12 relative z-20">
          ...
          {daftar_paket.length === 0 ? (
             <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
                ...
                <p className="text-gray-500 mt-2">Paket tes karakter belum tersedia saat ini.</p>
             </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                {daftar_paket.map((paket) => {
                    ...
                    <div 
                        ...
                        ${isPremium ? 'border-2 border-yellow-400 shadow-yellow-100 ring-4 ring-yellow-50' : 'border border-gray-100 shadow-md'}
                        `}
                    >
                        {/* Badge Status Token */}
                        {paket.has_token && (
                        ...
                        <div className="p-8 flex-1 flex flex-col">
                            {/* Header Paket */}
                            <div className="mb-6">
                                <h2 className="text-xl font-bold text-gray-900 mb-2">{paket.nama_paket}</h2>
                            ...
                            <div className="mb-8 pb-8 border-b border-gray-100">
                                <div className="flex items-baseline">
                                    ...
                                    <span className="text-gray-400 ml-2 font-medium">/ tes</span>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-4 mb-8 flex-1">
                                <li className="flex items-start gap-3">
                                    <div className="flex-shrink-0 w-5 h-5 rounded-full bg-yellow-100 flex items-center justify-center mt-0.5">
                                        <svg className="w-3 h-3 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                                    </div>
                                    <span className="text-sm text-gray-600">Laporan Lengkap <strong className="text-gray-900">{paket.jumlah_karakter} Karakter</strong></span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <div className="flex-shrink-0 w-5 h-5 rounded-full bg-yellow-100 flex items-center justify-center mt-0.5">
                                        <svg className="w-3 h-3 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                            ...
                            <div className="mt-auto">
                                {paket.has_token ? (
                                    <Link href={`/personal/formTes?paket_id=${paket.id_paket}`} className="block w-full"> 
                                    ...
                                    <Link href="/personal/transaksiTokenPersonal" className="block w-full"> 
                                        <button className={`w-full py-4 rounded-xl font-bold border-2 transition-all flex items-center justify-center gap-2 
                                            ${isPremium 
