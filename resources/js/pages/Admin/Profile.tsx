...
export default function Profile() {
    ...
    // Handler untuk menangani pengiriman form
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        alert('Simulasi: Data berhasil disimpan!\nCek konsol untuk data.');
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2">
                    <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm md:p-8">
                        ...
                        {/* PENTING: onSubmit sekarang memanggil fungsi handleSubmit yang sudah didefinisikan */}
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    {/* PENTING: onChange sekarang memanggil fungsi handleChange */}
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    {/* Catatan: Input ini readOnly, jadi onChange-nya tidak benar-benar berfungsi, tetapi tetap dipertahankan untuk konsistensi */}
