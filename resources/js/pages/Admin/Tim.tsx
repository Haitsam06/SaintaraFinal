...
export default function Team() {
    ...
    const renderAbsensi = () => (
        <div className="animate-fade-in space-y-6">
            <h3 className="text-lg font-bold text-gray-900">Absensi Bulan Oktober 2025</h3>
                ...
                <table className="w-full min-w-[600px]">
                    <thead className="bg-gray-100 text-sm text-gray-900 uppercase">
                        <tr>
                            ...
                            <th className="px-4 py-3 text-left font-bold">Jam Masuk</th>
                            <th className="px-4 py-3 text-left font-bold">Jam Pulang</th>
                    ...
                    <tbody className="divide-y divide-gray-100 bg-white text-sm text-gray-800">
                        <tr>
                            ...
                            <td className="px-4 py-3 text-center">
                                <span className="rounded-full border border-green-200 bg-green-100 px-3 py-1 text-xs font-bold text-green-700">Hadir</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td className="px-4 py-3">-</td>
                            <td className="px-4 py-3 text-center">
                                <span className="rounded-full border border-red-200 bg-red-100 px-3 py-1 text-xs font-bold text-red-700">Absen</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    const renderLaporanKerja = () => (
        <div className="animate-fade-in space-y-6">
            <div className="flex items-center justify-between">
                <h3 className="text-lg font-bold text-gray-900">Daftar Laporan Kerja Harian</h3>
                <button className="rounded-full bg-yellow-400 px-4 py-2 text-sm font-bold text-gray-900 shadow-md transition-colors hover:bg-yellow-500">Buat Laporan Baru</button>
            </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
                <div>
                    <h4 className="text-lg font-bold text-gray-900">Laporan - Budi Santoso</h4>
                    <p className="mt-1 text-sm text-gray-500">Tanggal: 5 Oktober 2025</p>
                </div>
                <button className="text-sm font-bold text-yellow-600 hover:text-yellow-700">Lihat Laporan</button>
            </div>
        </div>
    );
    ...
    const renderPerforma = () => (
        <div className="animate-fade-in space-y-6">
            <h3 className="text-lg font-bold text-gray-900">Performa Tim & Agen</h3>

            {/* Grafik Placeholder */}
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <h4 className="mb-4 font-bold text-gray-800">Pencapaian Target Tim Marketing</h4>
                <div className="flex h-48 w-full items-center justify-center rounded-lg bg-gray-200">
                    <span className="text-sm text-gray-500">Grafik Performa Tim akan ditampilkan disini</span>
                </div>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <div className="mb-2 flex items-end justify-between">
                    <div>
                        <p className="mb-1 text-xs text-gray-500">Pencapaian Individu (Agen)</p>
                        <h4 className="font-bold text-gray-800">Agen A - Rina Wulandari</h4>
                    </div>
                    <span className="text-sm font-bold text-gray-600">85 dari 100 Tes</span>
                </div>
    ...
    // Tabs List
    const tabs = ['Data Absensi', 'Laporan Kerja', 'Performa'];
    ...
    return (
        <AdminDashboardLayout>
            ...
            <div className="space-y-6 font-poppins">
                <h2 className="text-3xl font-bold text-blue-900">Manajemen Tim</h2>
