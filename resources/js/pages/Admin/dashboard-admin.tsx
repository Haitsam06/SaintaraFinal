                        ...
                        <div className="flex flex-col items-center justify-center gap-10 md:flex-row">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <span className="h-4 w-4 rounded-full bg-[#FCD34D]"></span> {/* Kuning Muda */}
                                    <span className="text-sm font-medium text-gray-600">Personal</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <span className="h-4 w-4 rounded-full bg-[#A16207]"></span> {/* Coklat/Emas Tua */}
                                    <span className="text-sm font-medium text-gray-600">Institution</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <span className="h-4 w-4 rounded-full bg-[#FFFF00]"></span> {/* Kuning Terang */}
                            ...
                            <div
                                ...
                                style={{
                                    background: 'conic-gradient(#FCD34D 0% 35%, #FFFF00 35% 45%, #A16207 45% 100%)',
                                }}
                            >
                                {/* Lubang Tengah Donut */}
                    ...
                    <div className="flex flex-col justify-between rounded-3xl bg-white p-8 shadow-sm lg:col-span-1">
                        <div>
                            ...
                            <div className="relative ml-2 space-y-6 border-l-2 border-gray-100 pl-6">
                                ...
                                <div className="relative">
                                    <span className="absolute top-1 -left-[31px] h-3 w-3 rounded-full bg-yellow-400"></span>
                                    <h4 className="font-bold text-gray-800">Penawaran Kerja sama</h4>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    <div className="rounded-3xl bg-white p-6 shadow-sm">
                        <div className="mb-4 flex items-start justify-between">
                            <div>
                                <p className="text-xs text-gray-400">Penjualan Token Bulan ini</p>
                                ...
                                <span className="mt-1 inline-flex items-center text-xs font-bold text-green-500">
                                    <span className="mr-2 h-2 w-2 rounded-full bg-green-500"></span> On track
                                </span>
                            </div>
                    ...
                    <div className="flex flex-col justify-between rounded-3xl bg-white p-6 shadow-sm">
                        <h3 className="mb-4 text-lg font-bold text-gray-800">Laporan Harian Tim</h3>
                        <div className="space-y-4">
                            {/* User 1 */}
                            <div className="flex items-center gap-3">
                                <img src="https://i.pravatar.cc/150?u=1" alt="User" className="h-10 w-10 rounded-full object-cover" />
                                <div>
                                    <h5 className="text-sm font-bold text-gray-800">Lia Kaula</h5>
                                    <p className="text-xs text-gray-400">Keuangan</p>
                                </div>
                            </div>
                            {/* User 2 */}
                            <div className="flex items-center gap-3">
                                <img src="https://i.pravatar.cc/150?u=2" alt="User" className="h-10 w-10 rounded-full object-cover" />
                                <div>
                                    <h5 className="text-sm font-bold text-gray-800">Andi Kindy</h5>
                                    <p className="text-xs text-gray-400">Marketing</p>
                                </div>
                            </div>
                            {/* User 3 */}
                            <div className="flex items-center gap-3">
                                <img src="https://i.pravatar.cc/150?u=3" alt="User" className="h-10 w-10 rounded-full object-cover" />
                                <div>
                                    <h5 className="text-sm font-bold text-gray-800">Bayu Subaya</h5>
                    ...
                    <div className="rounded-3xl bg-white p-6 shadow-sm">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="font-bold text-gray-700">Tim IT</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <HiCurrencyDollar className="h-6 w-6 text-green-500" />
                                <span className="font-bold text-gray-700">Tim Keuangan</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <HiUsers className="h-6 w-6 text-pink-500" />
                                <span className="font-bold text-gray-700">Tim Marketing</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <HiWrench className="h-6 w-6 text-yellow-600" />
                                <span className="font-bold text-gray-700">Tim Operasional</span>
                            </div>
                        </div>
                    </div>
                </div>
